...
- [ ] Spustit test scrapingu a uložit výsledky do `log.md`. (Přeskočeno kvůli omezením prostředí)
- [ ] Zkontrolovat `log.md` pro ověření správnosti opravy. (Přeskočeno kvůli omezením prostředí)
- [ ] Vyčistit a odeslat finální kód.
